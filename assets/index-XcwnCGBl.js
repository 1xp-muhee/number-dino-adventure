...
`;var Nc={stage:document.querySelector(`#three-stage`),rewardCount:document.querySelector(`#reward-count`),streakCount:document.querySelector(`#streak-count`),modeLabel:document.querySelector(`#mode-label`),hintTitle:document.querySelector(`#hint-title`),hintText:document.querySelector(`#hint-text`),uiModeEgg:document.querySelector(`#ui-mode-egg`),uiModeBlock:document.querySelector(`#ui-mode-block`),uiStart:document.querySelector(`#ui-start`),uiReplay:document.querySelector(`#ui-replay`)},Pc=`/number-dino-adventure/`,Fc=e=>`${Pc}audio/${e}`,Ic={warmup:Fc(`warmup.mp3`),introEgg:Fc(`intro-egg.mp3`),success:Fc(`success.mp3`),retry:Fc(`retry.mp3`),mission:{egg:{1:Fc(`mission-egg-1.mp3`),2:Fc(`mission-egg-2.mp3`),3:Fc(`mission-egg-3.mp3`),4:Fc(`mission-egg-4.mp3`),5:Fc(`mission-egg-5.mp3`),6:Fc(`mission-egg-6.mp3`)},block:{1:Fc(`mission-block-1.mp3`),2:Fc(`mission-block-2.mp3`),3:Fc(`mission-block-3.mp3`),4:Fc(`mission-block-4.mp3`),5:Fc(`mission-block-5.mp3`),6:Fc(`mission-block-6.mp3`)}}},$={reward:0,streak:0,mode:`egg`,target:3,stage:`ready`,locked:!1,userInteracted:!1,audioReady:!1,currentAudio:null,audioQueue:[],audioPlaying:!1},Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc,qc,Jc,Yc,Xc=[],Zc=[],Qc=[],$c=[],el=new Map,tl=[],nl=[],rl=new G(0,3.8,.6);function il(e,t){Nc.hintTitle.textContent=e,Nc.hintText.textContent=t}function al(){Nc.rewardCount.textContent=$.reward,Nc.streakCount.textContent=$.streak,Nc.modeLabel.textContent=jc[$.mode].label,Nc.uiModeEgg.classList.toggle(`active`,$.mode===`egg`),Nc.uiModeBlock.classList.toggle(`active`,$.mode===`block`),Nc.uiStart.textContent=$.stage===`won`?`다음 문제`:`문제 시작`}function ol(){$.currentAudio&&=($.currentAudio.pause(),$.currentAudio.currentTime=0,null),$.audioPlaying=!1,$.audioQueue=[],`speechSynthesis`in window&&window.speechSynthesis.cancel()}function sl(e){if(!e){$.audioPlaying=!1;return}if(!$.userInteracted){$.audioQueue.unshift(e),$.audioPlaying=!1;return}if(e.src){let t=new Audio(e.src);t.preload=`auto`,t.playsInline=!0,$.currentAudio=t,$.audioPlaying=!0,t.play().then(()=>{t.addEventListener(`ended`,()=>{$.currentAudio===t&&($.currentAudio=null),sl($.audioQueue.shift())},{once:!0})}).catch(()=>{$.currentAudio=null,$.audioPlaying=!1,il(`소리 다시 켜기`,`아이폰에서 소리가 막혔어요. 아래 다시 듣기 버튼을 한 번 눌러 주세요.`)});return}$.audioPlaying=!1}function cl(e,{replace:t=!1}={}){let n=e.filter(Boolean);n.length&&(t&&($.currentAudio&&=($.currentAudio.pause(),$.currentAudio.currentTime=0,null),`speechSynthesis`in window&&window.speechSynthesis.cancel(),$.audioQueue=[],$.audioPlaying=!1),$.audioQueue.push(...n),$.audioPlaying||sl($.audioQueue.shift()))}function ll(){Object.values(Ic).forEach(e=>{if(typeof e==`string`){let t=new Audio(e);t.preload=`auto`,t.load();return}Object.values(e).forEach(e=>{Object.values(e).forEach(e=>{let t=new Audio(e);t.preload=`auto`,t.load()})})})}function ul(){$.userInteracted=!0,$.audioReady||($.audioReady=!0,ll()),!$.audioPlaying&&$.audioQueue.length&&sl($.audioQueue.shift())}function dl(){return Math.floor(Math.random()*6)+1}function fl(){return $.mode===`egg`?`${kc[$.target]}! 알 ${$.target}개를 골라 보자!`:`${kc[$.target]}! 블록 ${$.target}개를 골라 보자!`}function pl(){return Ic.mission[$.mode]?.[$.target]}function ml(e,t){let n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`),i=new Ur(n);return i.colorSpace=Ie,{canvas:n,ctx:r,texture:i}}function hl(e,t,n){return new Y(new Zr(t,n),new yr({map:e.texture,transparent:!0}))}function gl(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath(),e.fill()}function _l(e,t,n,r=t/2){let i=new Y(new qr(e,t,n),new yr({transparent:!0,opacity:0}));return i.position.y=r,i}function vl(e,t){e.userData.onTap=t,e.traverse(t=>{t.userData.root=e,t.isMesh&&Xc.push(t)})}function yl(e){let t=e;for(;t;){if(t.userData?.onTap)return t;t=t.parent}return e.userData?.root??null}function bl(){Rc.background=new J(9492735),Rc.fog=new pn(9492735,40,95),Rc.add(new Wi(16777215,2.4));let e=new Ui(16777215,2.2);e.position.set(18,24,8),Rc.add(e);let t=new Ui(11196671,.9);t.position.set(-12,8,20),Rc.add(t)}function xl(){Wc=new an,Rc.add(Wc);let e=new li({color:7328875,roughness:1}),t=new li({color:6277469,roughness:1}),n=new li({color:13077844,roughness:1}),r=new li({color:10317376,roughness:1});for(let i=-8;i<=8;i+=1)for(let a=-8;a<=8;a+=1){let o=Math.max(0,Math.round((Math.sin(i*.45)+Math.cos(a*.55))*.3+1));for(let s=0;s<=o;s+=1){let c=new Y(new qr(2,2,2),s===o?o%2==0?t:e:s%2==0?n:r);c.position.set(i*2,s*2,a*2),Wc.add(c)}}let i=new li({color:15254138,roughness:1});for(let e=-4;e<=4;e+=1){let t=new Y(new qr(2.1,.7,2.1),i);t.position.set(e*2.2,4.35,6.1-Math.abs(e)*.22),Wc.add(t)}let a=new Y(new qr(34,.6,8),new li({color:4830463,transparent:!0,opacity:.88,roughness:.2,metalness:.08}));a.position.set(0,1.5,17),Wc.add(a)}function Sl(){let{ctx:e,canvas:t,texture:n}=Uc;e.clearRect(0,0,t.width,t.height);let r=e.createLinearGradient(0,0,t.width,t.height);r.addColorStop(0,`#fff8da`),r.addColorStop(1,`#ffe6a2`),e.fillStyle=r,gl(e,28,28,t.width-56,t.height-56,44),e.fillStyle=`#704100`,e.textAlign=`center`,e.font=`900 70px Pretendard, sans-serif`,e.fillText(`공룡 미션 보드`,t.width/2,120),e.font=`800 54px Pretendard, sans-serif`,e.fillText(jc[$.mode].label,t.width/2,215),e.fillStyle=`#2b4d9b`,e.font=`900 280px Pretendard, sans-serif`,e.fillText(String($.target),t.width/2,520),e.fillStyle=`#6d5610`,e.font=`800 64px Pretendard, sans-serif`,e.fillText(kc[$.target],t.width/2,610),e.fillStyle=`#234`,e.font=`700 44px Pretendard, sans-serif`;let i=$.stage===`playing`?`반짝이는 숫자 오브젝트를 골라요!`:$.stage===`won`?`성공! 초록 블록으로 다음 미션!`:`초록 출발 블록을 눌러요!`;e.fillText(i,t.width/2,770),e.font=`700 40px Pretendard, sans-serif`,e.fillText(`별 ${$.reward}   ·   연속 ${$.streak}`,t.width/2,860),n.needsUpdate=!0,$.stage===`playing`?il(`지금 할 일`,`${fl()} 맞는 숫자를 눌러 주세요.`):$.stage===`won`?il(`잘했어요!`,`아래 문제 시작 버튼을 눌러 다음 문제로 가요.`):il(`준비 완료`,`${jc[$.mode].prep}. 아래 문제 시작 버튼을 눌러요.`)}function Cl(){Yc=new an,Yc.position.set(0,2.3,-12.3);let e=new li({color:9065768,roughness:1}),t=new li({color:7027742,roughness:1}),n=new Y(new qr(1.2,9.4,1.2),e);n.position.set(-5.1,4.4,0),Yc.add(n);let r=n.clone();r.position.x=5.1,Yc.add(r);let i=new Y(new qr(10.5,10.2,.8),t);i.position.set(0,5.1,.1),Yc.add(i),Uc=ml(1024,1120);let a=hl(Uc,9.5,10.35);a.position.set(0,5.1,.52),Yc.add(a);let o=new li({color:13847871,roughness:1}),s=new Y(new qr(6.2,.8,2),o);s.position.set(-1.5,9.9,0),s.rotation.z=Math.PI/7,Yc.add(s);let c=s.clone();c.position.x=1.5,c.rotation.z=-Math.PI/7,Yc.add(c),Gc.add(Yc)}function wl(e,{title:t,subtitle:n,primary:r,secondary:i,text:a,active:o}){let{ctx:s,canvas:c,texture:l}=e;s.clearRect(0,0,c.width,c.height);let u=s.createLinearGradient(0,0,c.width,c.height);u.addColorStop(0,r),u.addColorStop(1,i),s.fillStyle=u,gl(s,16,16,c.width-32,c.height-32,34),s.strokeStyle=o?`rgba(255,255,255,0.95)`:`rgba(255,255,255,0.35)`,s.lineWidth=o?12:6,s.strokeRect(28,28,c.width-56,c.height-56),s.textAlign=`center`,s.fillStyle=a,s.font=`900 62px Pretendard, sans-serif`,s.fillText(t,c.width/2,110),s.font=`800 34px Pretendard, sans-serif`,s.fillText(n,c.width/2,170),l.needsUpdate=!0}function Tl(e){let t=new an;t.position.copy(e.position),t.userData.id=e.id;let n=new li({color:9348024,roughness:1}),r=new li({color:6452103,roughness:1}),i=new li({color:e.color,emissive:e.color,emissiveIntensity:.55,roughness:.45}),a=new Y(new qr(3.6,1.8,3.6),n);a.position.y=.9,t.add(a);let o=new Y(new qr(2.4,2.2,2.4),r);o.position.y=2.6,t.add(o);let s=new Y(new qr(3,.8,3),n);s.position.y=4,t.add(s);let c=e.buildTop(i);c.position.y=5.4,t.add(c);let l=ml(512,256),u=hl(l,4.6,2.3);return u.position.set(0,8.1,.2),t.add(u),t.add(_l(4.6,7.8,4.6,4)),t.userData.ornament=c,el.set(e.id,l),Zc.push({mesh:c,scale:.08,speed:e.speed??2.2,phase:Math.random()*Math.PI*2}),vl(t,e.onTap),Gc.add(t),t}function El(){let e=Tl({id:`mode-egg`,position:new G(-32,2.2,-18),color:16768372,speed:2.4,buildTop(e){let t=new Y(new Qr(1.15,24,24),e);return t.scale.y=1.25,t},onTap:()=>Fl(`egg`)}),t=Tl({id:`mode-block`,position:new G(32,2.2,-18),color:7918591,speed:2.1,buildTop(e){let t=new an,n=new Y(new qr(1.9,1.9,1.9),e),r=n.clone();return r.scale.set(.82,.82,.82),r.position.y=1.45,t.add(n,r),t},onTap:()=>Fl(`block`)}),n=Tl({id:`start`,position:new G(-48,2.2,28),color:9240433,speed:2.7,buildTop(e){let t=new Y(new qr(2.5,1.1,2.5),e);return t.rotation.y=Math.PI/4,t},onTap:()=>Ll()}),r=Tl({id:`replay`,position:new G(48,2.2,28),color:16742856,speed:2.3,buildTop(e){return new Y(new Xr(1.35,0),e)},onTap:()=>Il()});Gc.userData.pedestals={egg:e,block:t,start:n,replay:r}}function Dl(){let e=$.mode===`egg`,t=$.mode===`block`;wl(el.get(`mode-egg`),{title:`알`,subtitle:e?`선택됨`:`고르기`,primary:`#ffe479`,secondary:`#ffbc4b`,text:`#5d3b00`,active:e}),wl(el.get(`mode-block`),{title:`블록`,subtitle:t?`선택됨`:`고르기`,primary:`#8ce8ff`,secondary:`#38afff`,text:`#0a4164`,active:t}),wl(el.get(`start`),{title:$.stage===`won`?`다음 문제`:`시작`,subtitle:`문제 보기`,primary:`#a6ff88`,secondary:`#42cb56`,text:`#12401d`,active:!0}),wl(el.get(`replay`),{title:`다시 듣기`,subtitle:`문제 음성`,primary:`#ffb5e1`,secondary:`#ff6ebd`,text:`#6b174e`,active:$.stage===`playing`})}function Ol(){for(;Kc.children.length;)Kc.remove(Kc.children[0]);tl.length=0}function kl(e,t,n){let{ctx:r,canvas:i,texture:a}=e;r.clearRect(0,0,i.width,i.height);let o=r.createLinearGradient(0,0,i.width,i.height);o.addColorStop(0,n.top),o.addColorStop(1,n.bottom),r.fillStyle=o,gl(r,18,18,i.width-36,i.height-36,36),r.textAlign=`center`,r.fillStyle=n.text,r.font=`900 116px Pretendard, sans-serif`,r.fillText(String(t),i.width/2,158),r.font=`800 38px Pretendard, sans-serif`,r.fillText(`${kc[t]} 개`,i.width/2,220),a.needsUpdate=!0}function Al(e,t){let n=ml(360,260);kl(n,e,t===`egg`?{top:`#fff2a2`,bottom:`#ffd061`,text:`#754900`}:{top:`#b3ecff`,bottom:`#63bfff`,text:`#0b476a`}),tl.push(n);let r=hl(n,2.85,2.05);return r.position.set(0,6.1,.2),r}function jl(e,t){let n=new an;n.position.copy(t);let r=new li({color:14856018,roughness:1}),i=new li({color:16774879,roughness:.9}),a=new li({color:16773306,roughness:.8}),o=new Y(new Jr(2.45,2.85,1.05,16),r);o.position.y=2.9,n.add(o);let s=new Y(new $r(1.7,.42,12,24),r);s.rotation.x=Math.PI/2,s.position.y=3.15,n.add(s);let c=[[0,0],[-.72,-.28],[.72,.28],[-.78,.78],[.86,-.68],[0,.96]];for(let t=0;t<e;t+=1){let[e,r]=c[t],o=new Y(new Qr(.6,20,20),t%2==0?i:a);o.scale.y=1.38,o.position.set(e,3.82+t%2*.04,r),n.add(o)}let l=Al(e,`egg`);l.position.y=6.55,n.add(l),n.add(_l(5.2,6.4,5.2,4.6)),n.userData.value=e,vl(n,()=>Hl(n)),Zc.push({mesh:n,scale:.04,speed:1.5+e*.12,phase:e*.45}),Kc.add(n)}function Ml(e,t){let n=new an;n.position.copy(t);let r=[16748400,16764245,8445299,6080767,12819199,16746188],i=new Y(new qr(3.2,.95,3.2),new li({color:9072466,roughness:1}));i.position.y=2.7,n.add(i);for(let t=0;t<e;t+=1){let e=new Y(new qr(2.1,1.4,2.1),new li({color:r[t%r.length],roughness:.82}));e.position.y=3.8+t*1.32,e.rotation.y=t%2*.12,n.add(e)}let a=Al(e,`block`);a.position.y=8.1,n.add(a),n.add(_l(5.2,10.4,5.2,6)),n.userData.value=e,vl(n,()=>Hl(n)),Zc.push({mesh:n,scale:.04,speed:1.4+e*.1,phase:e*.38}),Kc.add(n)}function Nl(){Ol(),[new G(-13.5,0,-.4),new G(-8.1,0,1.2),new G(-2.7,0,-.3),new G(2.7,0,-.3),new G(8.1,0,1.2),new G(13.5,0,-.4)].forEach((e,t)=>{let n=t+1;$.mode===`egg`?jl(n,e):Ml(n,e)})}function Pl(){Ol(),$.locked=!1,$.stage=`ready`,$.target=dl(),Sl(),Dl(),al()}function Fl(e){Ac.includes(e)&&($.mode=e,ol(),Pl(),cl([{src:pl()}],{replace:!0}))}function Il(){if($.stage!==`playing`){cl([{src:pl()}],{replace:!0});return}cl([{src:pl()}],{replace:!0})}function Ll(){ol(),($.stage===`won`||$.stage===`playing`)&&($.target=dl()),$.stage=`playing`,$.locked=!1,Nl(),Sl(),Dl(),al();let e=[];$.mode===`egg`&&$.reward===0&&$.streak===0&&e.push({src:Ic.introEgg}),e.push({src:pl()}),cl(e,{replace:!0})}function Rl(e,t,n=20){for(let r=0;r<n;r+=1){let n=new Y(new qr(.28,.28,.28),new li({color:t,emissive:t,emissiveIntensity:.55,roughness:.5}));n.position.copy(e),n.position.y+=1+Math.random()*1.5,$c.push({mesh:n,velocity:new G((Math.random()-.5)*6,3.5+Math.random()*4,(Math.random()-.5)*4),spin:new G(Math.random()*4,Math.random()*4,Math.random()*4),age:0,life:.9+Math.random()*.5}),Jc.add(n)}}function zl(e,t){nl.push({fn:e,delayMs:t,elapsed:0})}function Bl(e){$.locked=!0,$.stage=`won`,$.reward+=$.target,$.streak+=1,Rl(e.getWorldPosition(new G),$.mode===`egg`?16767069:8837631,26),cl([{src:Ic.success}],{replace:!0}),Sl(),Dl(),al(),zl(()=>Ol(),520)}function Vl(e){$.locked=!1,$.streak=0,Rl(e.getWorldPosition(new G),16744298,10),cl([{src:Ic.retry}],{replace:!0}),Sl(),al()}function Hl(e){$.stage!==`playing`||$.locked||(e.userData.value===$.target?Bl(e):Vl(e))}function Ul(e,t){ul();let n=Lc.domElement.getBoundingClientRect();Vc.x=(e-n.left)/n.width*2-1,Vc.y=-((t-n.top)/n.height)*2+1,Bc.setFromCamera(Vc,zc);let r=Bc.intersectObjects(Xc,!0);r.length&&yl(r[0].object)?.userData?.onTap?.()}function Wl(e){Ul(e.clientX,e.clientY)}function Gl(e){let t=e.changedTouches?.[0];t&&(e.preventDefault(),Ul(t.clientX,t.clientY))}function Kl(e){Ul(e.clientX,e.clientY)}function ql(){zc.aspect=window.innerWidth/window.innerHeight,zc.updateProjectionMatrix(),Lc.setSize(window.innerWidth,window.innerHeight)}function Jl(){requestAnimationFrame(Jl);let e=Math.min(Hc.getDelta(),.033),t=Hc.elapsedTime;zc.lookAt(rl),Qc.forEach(e=>{e.mesh.position.y=e.baseY+Math.sin(t*e.speed+e.phase)*e.amplitude,e.drift&&(e.mesh.position.x=e.mesh.userData.baseX+Math.sin(t*e.mesh.userData.drift+e.phase)*1.6)}),Zc.forEach(e=>{if(!e.mesh.parent)return;let n=1+Math.sin(t*e.speed+e.phase)*e.scale;e.mesh.scale.setScalar(n)});for(let t=nl.length-1;t>=0;--t){let n=nl[t];n.elapsed+=e*1e3,n.elapsed>=n.delayMs&&(n.fn(),nl.splice(t,1))}for(let t=$c.length-1;t>=0;--t){let n=$c[t];if(n.age+=e,n.age>=n.life){Jc.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),$c.splice(t,1);continue}n.velocity.y-=8.2*e,n.mesh.position.addScaledVector(n.velocity,e),n.mesh.rotation.x+=n.spin.x*e,n.mesh.rotation.y+=n.spin.y*e,n.mesh.rotation.z+=n.spin.z*e;let r=1-n.age/n.life;n.mesh.scale.setScalar(Math.max(.2,r)),n.mesh.material.opacity=r,n.mesh.material.transparent=!0}Lc.render(Rc,zc)}function Yl(){Lc=new Oc({antialias:!0,alpha:!1}),Lc.setPixelRatio(Math.min(window.devicePixelRatio,2)),Lc.setSize(window.innerWidth,window.innerHeight),Nc.stage.appendChild(Lc.domElement),Rc=new mn,zc=new Bi(46,window.innerWidth/window.innerHeight,.1,200),zc.position.set(0,18,11.5),Bc=new sa,Vc=new W,Hc=new ua,qc=new an,Gc=new an,Kc=new an,Jc=new an,Rc.add(qc,Gc,Kc,Jc),bl(),xl(),Cl(),El(),Dl(),Sl(),Lc.domElement.addEventListener(`pointerdown`,Wl),Lc.domElement.addEventListener(`touchstart`,Gl,{passive:!1}),Lc.domElement.addEventListener(`click`,Kl),window.addEventListener(`resize`,ql)}Nc.uiModeEgg.addEventListener(`click`,()=>{ul(),Fl(`egg`)}),Nc.uiModeBlock.addEventListener(`click`,()=>{ul(),Fl(`block`)}),Nc.uiStart.addEventListener(`click`,()=>{ul(),Ll()}),Nc.uiReplay.addEventListener(`click`,()=>{ul(),Il()}),al(),Yl(),Pl(),Jl();